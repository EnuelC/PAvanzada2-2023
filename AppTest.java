...
public class AppTest {
	...
	public void testSuma1() {
		assertEquals(App.sumar(5.0, 6.0), 11.0, 0.0001);
	}
	...
	public void testResta2() {
		assertTrue(App.restar(2.0,1.0) == 1);
	}
	...
	public void testMulti3() {
		assertEquals(App.multiplicar(4,0), 0, 0.000);
	}
	...
	public void testDivi1() {
		assertEquals(App.dividir(4.0,2.0), 2.0, 0.0001);
	}
